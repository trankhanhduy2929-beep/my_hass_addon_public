...
|---|---:|---|---|---|
| HANET Connect Gateway | `0.10.0` | experimental | `amd64, aarch64` | [Open](addon_hanet_connect/README.md) |
...
| YouTube Pro | `5.1.0` | stable | `amd64, aarch64` | [Open](youtube_pro_addon/README.md) |
