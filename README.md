...
|---|---:|---|---|---|
| HANET Connect Gateway | `0.9.0` | experimental | `amd64, aarch64` | [Open](addon_hanet_connect/README.md) |
...
| YouTube Music Cinematic | `1.20.22` | stable | `amd64, aarch64` | [Open](youtube_cast_addon/README.md) |
