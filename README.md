...
|---|---:|---|---|---|
| HANET Connect Gateway | `0.10.3` | experimental | `amd64, aarch64` | [Open](addon_hanet_connect/README.md) |
...
| YouTube Pro | `5.2.1` | stable | `amd64, aarch64` | [Open](youtube_pro_addon/README.md) |
